...
>
  ...
  <p>
    {order.shippingAddress.street === 'Pickup'
      ? 'Pickup'
      : `${order.shippingAddress.street}, ${order.shippingAddress.barangay}, ${order.shippingAddress.city}, ${order.shippingAddress.province} ${order.shippingAddress.postalCode}`}
  </p>
